<?php
    ...
    if(isset($_POST['btn']))
    {
      ...
      // $fsignature=$_POST['fsignature'];
       ...
       $sql="INSERT INTO `hloan` ( `prefix`, `name`, `mothername`, `fathername`, `flatno`, `buildingname`, `streetname`, `city`, `districtname`, `pincode`,
...
<body style="margin-left:30px;margin-left:0px;">
    <div class="header">
  ...
  <form data-multi-step class="multi-step-form" method="post" enctype="multipart/form-data">
    <div class="card"  data-step>
        ...
        <div class="form-group"style="display: inline;">
          ...
          <select name="prefix" id="" style="width: 60px;padding:10px;margin-left: 100px; " required value="Mrs"> 
          ...
          <input type="text" name="name" id="cname" placeholder="Enter Full Name" style=" width:400px;"required ><br>
          <!-- <label for="ckyc">CKYC</label>
          <input type="number" name="ckyc" id="" maxlength="14"><br>  -->
          <label for="name">Mother Name</label> <input type="text" name="mothername" id=""style="width: 400px;margin-left: 30px; " placeholder="Mother Name"required >
          <label for="name">Father Name</label> <input type="text" name="fathername" id=""style="width: 400px; " placeholder="Father Name"required ><br>
          <label for="address">Address</label>
          <input type="text" style="width:50px;padding:10px;margin-left: 80px;"placeholder="Flat no" name="flatno"required>
          <input type="text" style="width:300px;padding:10px; "placeholder="Bulding / Premises Name"name="buildingname"required>
          <input type="text" style="width:300px;padding:10px;"placeholder="Street/Road Name"name="streetname"required>
          <input type="text" style="width:300px;padding:10px;margin-left: 190px;"placeholder="Town/City/Village Name"name="city"required>
          <input type="text" style="width:300px;padding:10px;"placeholder="Distrit Name"name="districtname"required>
          <input type="number" style="width:100px;padding:10px;"placeholder="PinCode"name="pincode"required><br>
          <label for="address">Current Address is</label>
          <label for="address" style="font-weight: 100;">Self-Owned</label>
          <input type="radio" name="currentaddressis" required>
          ...
          <input type="radio" name="currentaddressis" required><br>
          <label for="phno">Phone Number</label>
          <input type="number" name="phno" id="" style="margin-left: 20px;"placeholder="9975229636" minlength="10" maxlength="10"required><br>
          <label for="email">Email</label>
          <input type="text" style="width:300px;padding:10px;margin-left: 100px;"placeholder="john123@gmail.com"name="email"required><br>
          <label for="DOB">Date of Birth</label>
          <input type="date" style="width:300px;padding:10px;margin-left: 40px;"name="dob" onclick="agecal()" id="DOB"required>
          <label for="age">Age</label>
          <input type="number" style="width:50px;padding:10px;margin-left:10px;"name="age"  id="result"  minlength="1" maxlength="3"required>
          ...
          <label for="Ms"style="font-weight: 100;"required>Single</label>
          <input type="radio" name="maritualstatus">
          <label for="Ms"style="font-weight: 100;"required>Married</label>

          <input type="radio" name="ms">
          <label for="NOD">Number Of Dependents </label>
          <input type="number" style="width:50px;padding:10px;margin-left:10px;"name="numberofdependent"  minlength="1" maxlength="4"required><br>
          <label for="pan">PAN Number</label>
          <input type="text" name="panno" id="" style="margin-left: 40px;" placeholder="ABCPS1234A "  minlength="10" maxlength="10" required>
          <label for="UDI">UDI Number </label>
          <input type="text" name="udi" id="" style="margin-left: 10px;" placeholder="000011112222" minlength=12 maxlength=12 required><br>
          <label for="religion ">Religion</label> 
          <input type="text" name="religion" id="" style="margin-left: 95px; width: 300px;"required><br>
          <label for="occupation">Occupation</label>
          <label for="occupation" style="font-weight: 100;margin-left: 50px;"required>Employeed</label>
          <input type="radio" name="occupation">
          <label for="occupation" style="font-weight: 100;"required>Self-Employeed</label>
          <input type="radio" name="occupation">
          <label for="occupation" style="font-weight: 100;"required>Other</label>
          ...
          <input type="number" name="otherincome" required><br>
          <label for="CN">Company Name</label>
          <input type="text" name="cname" id="" placeholder="Enter Company Name" style=" width:400px;"required><br>
          ...
          <label for="address">Address</label>
          <input type="text" style="width:50px;padding:10px;margin-left: 80px;"placeholder="Block no" name="cblockno"required>
          <input type="text" style="width:300px;padding:10px; "placeholder="Bulding / Premises Name"name="cbuildingname"required>
          <input type="text" style="width:300px;padding:10px;"placeholder="Street/Road Name"name="cstreetname"required>
          <input type="text" style="width:300px;padding:10px;margin-left: 190px;"placeholder="Town/City/Village Name"name="ccity"required>
          <input type="text" style="width:300px;padding:10px;"placeholder="District Name"name="cdistrict"required>
          <input type="number" style="width:100px;padding:10px;"placeholder="PinCode"name="cpincode"required><br>
          <label for="exp">Yrs in Occupation</label>
          <input type="number" name="yrsinoccupation" style="width: 50px; margin: 0;"required>
          <label for="exp">Retirement Age</label>
          <input type="number" name="retairementage" style="width: 50px;"required>
          <label for="exp">Total Experience</label>
          <input type="number" name="totalexp" style="width: 50px;"required><br>
          <label for="eid">Employee ID</label>
          <input type="number" name="eid" style="width: 50px; margin-left: 45px;"required>
          <label for="Dept">Department</label>
          <input type="text"style="width:300px;padding:10px;"name="edepartment"required>
          <label for="Desi">Designation</label>
          <input type="text"style="width:300px;padding:10px;"name="edesignation"required><br>
        </div>
        <div class="form-group" style="display: inline;">
        ...
        <p style="text-align: center; font-weight: bold;">PLEASE MENTION DETAILS OF YOUR SALARY ACCOUNT / MAIN ACCOUNT INCASE SELF EMPLOYED</p>
          ...
          <input type="text" name="nameofaccholder" id="" style="margin-left: 50px; width: 400px;"required><br>
          <label for="nab">Bank Name</label>
          <input type="text" name="bankname" id="" style="margin-left:160px; width: 400px;"required><br>
          <label for="nabr">Branch Name</label>
          <input type="text" name="branchname" id="" style="margin-left: 140px; width: 400px;"required><br>
          <label for="ac">Account Number</label>
          <input type="text" name="accountnumber"   id="" style="margin-left:110px ; width: 400px;"required minlength="15" maxlength="15"><br>
          <label for="acdate"> A/c Operated Since</label>
          <input type="date" name="accopeningdate" id="" style="margin-left: 90px; width: 200px;"required>
          <label for="mcode">MICR Code</label>
          <input type="text" name="micr" id=""  minlength="9" maxlength="9"required>
          <label for="icode">IFSC Code</label>
          <input type="text" name="ifsc" id=""  minlength="11" maxlength="11" required>
    ...
    <div class="card" data-step>
      ...
      <div class="form-group" style="display: inline;">
        ...
        <input type="file" name="photograph" id="" style="width: 300px;margin-left: 180px; "required><br>
        <label for="sign" >Signature</label>
        <input type="file" name="signature" id="" style="width: 300px; margin-left: 198px;"required><br>
        <label for="adhar" >Aadhar Card</label>
        <input type="file" name="adharcard" id="" style="width: 300px; margin-left: 168px;"required><br>
        <label for="sign" >PAN</label>
        <input type="file" name="pancard" id="" style="width: 300px; margin-left: 243px;"required><br>
        <label for="LB" >Light Bill(3 Months)</label>
        <input type="file" name="lb1" id="" style="width: 240px; margin-left: 110px;"required>
        ...
        <input type="file" name="ss1" id="" style="width: 240px; margin-left: 30px;"required>
        ...
        <input type="file" name="itr1" id="" style="width: 250px;margin-left: 69px;"required>
        ...
        <input type="file" name="rentagreement" id="" style="width: 300px; margin-left: 149px;"required><br>
        <label for="owper" >Owner Permission</label>
        <input type="file" name="ownerpermission" id="" style="width: 300px; margin-left: 130px;"required><br>
    ...
    <div class="card" data-step>
      ...
      <div class="form-group" style="display: inline; ">
        ...
        <input type="number" name="term" id="" style="margin-left: 25px;"required><br>
        <label for="instalment">Instalment you can pay to Infinity Finance Bank per month</label>
        <input type="number" name="installments" id=""required><br>
        <label for="pdate">When would you prefer your loan to be:</label><br>
        <label for="sd"style="font-weight: 100;"required>Sanctioned</label>
        <input type="date" name="sd" id="">
        <label for="dd"style="font-weight: 100;"required>Disbursed</label>
        ...
        <input type="radio" name="rateopt" id=""required>
        <label for="ar"style="font-weight: 100;"required>Adjustable Rate</label>
        ...
        <input type="radio" name="chooseloantype" id=""required>
        ...
        <input type="radio" name="chooseloantype" id=""required><br>
    ...
    <div class="card" data-step >
        ...
        <input type="radio" name="purposeofloan" id=""required>
        ...
        <input type="radio" name="purposeofloan" id=""required><br>
        ...
        <input type="radio" name="purposeofloan" id=""required><br><br>
        ...
        <input type="number" name="ploatcost" id=""required><br>
        ...
        <input type="number" name="totalpurchsecost" id=""required><br>
        ...
        <input type="number" name="incidentalcost" id=""required><br>
        ...
        <input type="number" name="othercost" id=""required><br>
        ...
        <input type="number" name="marketvaluecost" id=""required><br>
        ...
        <input type="number" name="loanos" id=""required><br>
        ...
        <div class="form-group" style="position: absolute; top:140px;left:650px ;display: inline;">
          ...
          <input type="number" name="loanreq" id=""required><br>
          ...
          <input type="number" name="saving" id=""required><br>

          <label for="di" style="font-weight: 100;">Disposal of investments</label>
          <span class="material-symbols-outlined"style="margin-left: 180px;"> currency_rupee</span>
          <input type="number" name="disposal" id=""required><br>
          ...
          <input type="number" name="sale" id=""required><br>      
          
          <label for="pf" style="font-weight: 100;">Provident Fund </label>
          <span class="material-symbols-outlined"style="margin-left: 250px;"> currency_rupee</span>
          <input type="number" name="providentfund" id=""required><br>   
          ...
          <input type="number" name="estsoursefund" id=""required><br>
      ...
      <div class="card" data-step>
        ...
        <div class="form-group" style="display: inline;">
         ...
         <input type="radio" name="typeofproperty" id=""required>
         ...
         <input type="radio" name="typeofproperty" id=""required><br><br>

         <label for="aop">Address of Propety</label>
          <input type="text" style="width:50px;padding:10px;margin-left: 0px;"placeholder="Flat no" name="pflatno"required>
          <input type="text" style="width:300px;padding:10px; "placeholder="Bulding / Premises Name"name="pbuildingname"required>
          <input type="text" style="width:300px;padding:10px;"placeholder="Street/Road Name"name="pstreet"required>
          <input type="text" style="width:300px;padding:10px;margin-left: 190px;"placeholder="Town/City/Village Name"name="ptown"required>
          <input type="text" style="width:300px;padding:10px;"placeholder="Distrit Name"name="pdistrict"required>
          <input type="number" style="width:100px;padding:10px;"placeholder="PinCode"name="ppincode"required><br>

          <label for="natureofprop">Nature OF Property</label>
          <label for="natureofprop" style="font-weight: 100; ">Residential</label>
          <input type="radio" name="natureofprop" id=""required>
          <label for="natureofprop" style="font-weight: 100;">Commercial</label>
          <input type="radio" name="natureofprop" id=""required><br>

          <label for="aop">Area Of Property </label>
          <input type="number" name="areaofprop" id="" style="margin-left: 45px;"required>Sq.M <br>

          <label for="bua">Built-up area</label>
          <input type="number" name="buituparea" id="" style="margin-left: 80px;"required>Sq.M <br>

          <label for="soc">Stage of Construction</label>
          <input type="text" name="stageofconstruction" id="" style="width: 500px;"required><br>
      ...
      <div class="card" data-step>
        ...
        <div class="form-group" style="display: inline;">
          ...
          <input type="date" name="fdate" id="" style="margin-left: 50px; width: 250px;"required><br>
          <label for="plc">Place</label>
          <input type="text" name="place" id="" style="margin-left: 50px; width: 250px;"required><br>
          <label for="Signature">Signature</label>
          <input type="file" name="fsignature" id="" style="margin-left: 20px; width: 250px;"required><br>
        </div>
        <button type="button" data-previous>Previous</button>
