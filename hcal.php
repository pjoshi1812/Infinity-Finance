   ...
   <div class="header">
    ...
    <div class="loan-calculator" >
        <div class="left">
          ...
          <a href="hloan.php"><button value="next"class="calculate-btn" style="width:100px;margin-left:20px" >Next</button></a>
        </div>
      ...
      <footer>
        ...
        <div class="sec-quicklinks1">
            ...
            <ul class="info">
                <li>
                    <span><i class="fa-solid fa-phone" style="padding-left:75px;"></i></span><br><p style="text-align: center; padding-left:70px;">020-2332-445</p>
                </li><br>
                <li>
